    ...
    button.setOnClickListener ( new View.OnClickListener () {
      ...
      public void onClick(View v) {
        if (isGpsOn()||isNetworkOn ()) {
          ...
          Toast.makeText(MainActivity.this, "Cập nhật thành công vị trì của bạn!", Toast.LENGTH_SHORT).show();
        } else {
          Toast.makeText(MainActivity.this, "Vui lòng bật GPS!", Toast.LENGTH_SHORT).show();
        }
      }
    } );
...
// HAM TRA VE THOI TIET HIEN TAI BANG TEN THANH PHO
  ...
  private void permissionVersion(){
    if(Build.VERSION.SDK_INT >= 23){//Android 6 tro di
      ...
      Toast.makeText ( this, "Nhận diện thiết bị của bạn dưới Android 6", Toast.LENGTH_SHORT ).show ();
    }
  }
