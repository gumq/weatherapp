...
// Da ngon ngu
  private void setVariables() {
    ...
    if (AppUtil.isRTL(this)) {
      binding.dayNameTextView.setText(Constants.DAYS_OF_WEEK_VIETNAM[calendar.get(Calendar.DAY_OF_WEEK) - 1]);
    } else {
      binding.dayNameTextView.setText(Constants.DAYS_OF_WEEK_VIETNAM[calendar.get(Calendar.DAY_OF_WEEK) - 1]);
    }
    ...
    typeface = Typeface.createFromAsset(getAssets(), "fonts/RobotoMono-Medium.ttf");
  }
